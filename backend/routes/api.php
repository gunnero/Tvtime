...
Route::prefix('v1')->middleware('web')->group(function (): void {
    ...
    Route::get('/profiles/search', [ProfileController::class, 'search'])->middleware(['auth', 'throttle:30,1']);
    Route::get('/profiles/{user:profile_slug}', [ProfileController::class, 'show'])->middleware('throttle:60,1');
    Route::get('/friend-invites/{token}', [FriendInviteController::class, 'show'])->middleware('throttle:30,1');
    ...
    Route::middleware('auth')->group(function (): void {
        ...
        Route::patch('/profile', [ProfileController::class, 'update'])->middleware('throttle:6,60');
        Route::patch('/profile/privacy', [ProfileController::class, 'privacy'])->middleware('throttle:30,1');
        ...
        Route::post('/friends/request/{user:profile_slug}', [FriendshipController::class, 'requestFriend'])->middleware('throttle:10,1');
        Route::post('/friends/{friendship}/accept', [FriendshipController::class, 'accept'])->middleware('throttle:20,1');
        Route::post('/friends/{friendship}/decline', [FriendshipController::class, 'decline'])->middleware('throttle:20,1');
        Route::delete('/friends/{friendship}', [FriendshipController::class, 'destroy']);
        Route::post('/friends/{user:profile_slug}/block', [FriendshipController::class, 'block'])->middleware('throttle:10,1');
        Route::get('/friend-invites', [FriendInviteController::class, 'index']);
        Route::post('/friend-invites', [FriendInviteController::class, 'store'])->middleware('throttle:5,60');
        Route::post('/friend-invites/{token}/accept', [FriendInviteController::class, 'accept'])->middleware('throttle:10,1');
